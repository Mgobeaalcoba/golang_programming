...
func Index(rw http.ResponseWriter, r *http.Request) {
	...
	// template, err := template.ParseFiles("index.html", "base.html") // Puedo conectarme con tantos archivos HTML como desee. Renderiza el primer archivo y los demas están disponibles para aplicar herencia

	template, err := template.New("index.html").ParseFiles("index.html", "base.html") // Otra forma mas "limpia de decir lo mismo que arriba"
...
func main() {
	...
	fmt.Println("El servidor está corriendo en el puerto 5002")
	fmt.Println("Run server: http://localhost:5002")
