...
func main() {
	...
	models.MigrarUser() // Transforma el objeto user a una tabla users en el motor de base de datos. En este caso sin el registro de creación ya que por cada atributo se genera una columna y create_date no es un atributo de la struct user
